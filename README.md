...
3.0.0分支上，提供了一个新版本的SDK实现，主要包括了以下特性：
...
此外，在3.0.0分支上，还提供了以下信息，使用master分支版本的业务也可以进行参考：
 ...
 * @param appkey 业务appkey，可以传入腾讯云业务的UIN(即在https://console.cloud.tencent.com/developer页面的账号ID)，或者腾讯内部业务的手Q的appid
